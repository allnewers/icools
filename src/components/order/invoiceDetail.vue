<template>
  <div class="wrap">
    <div class="title">
      <span>普票-{{invoiceInfo.typeName}}</span>
      <span @click="edit(isEdit)" :class="{active:!isEdit}">{{isEdit?'编辑':'完成'}}</span>
    </div>
    <div class="detail">
      <div class="black"></div>
      <div class="jiao j-left">
        <img src="../../assets/img/dot.png" alt />
      </div>
      <div class="jiao j-right">
        <img src="../../assets/img/dot.png" alt />
      </div>
      <div class="piao">
        <div class="fa">
          <img src="../../assets/img/piao.png" alt />
        </div>
        <div class="top">
  ...
  methods: {
    ...
    submit() {
      ...
      if (
        ...
        num == this.invoiceInfo.identifyNumber &&
