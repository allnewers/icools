  ...
  <div>
    <div class="from">
      <ul>
        <li>
          <label for>姓名</label>
          <input type="text" v-model="formData.consignee" maxlength="30" placeholder="请输入姓名（必填）" required>
        </li>
        ...
        <li @click="popupVisible = true">
          <label for>地区</label>
          <input type="text" ref="area" :value="districtVal?districtVal:'请选择(必填)'" unselectable="on" onfocus="this.blur()" readonly>
        </li>
        <li>
          <label for>地址</label>
